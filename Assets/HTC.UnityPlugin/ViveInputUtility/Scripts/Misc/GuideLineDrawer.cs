...
{
	[Header("Ememy Aiming Line Color")]
	...
	private void Start()
	{
		__playerController = GameController.getInstance().player;
	}
	...
	protected virtual void LateUpdate()
    {
		...
		if ((result.gameObject != null) && (result.gameObject.tag == "EnemyBodyPart"))
			lineRenderer.material = activeColor;
		else
			lineRenderer.material = inactiveColor;

		__playerController.NotifyCurrentCastedObj(result.gameObject);
	}
